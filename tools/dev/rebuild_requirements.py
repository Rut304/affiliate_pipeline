...
STDLIB_HINTS = {'os','sys','json','time','re','subprocess','pathlib','typing','dataclasses','logging','argparse','shutil','itertools','functools','collections','math','random','uuid','csv','glob','tempfile','hashlib','base64','http','urllib','html','email','unittest','concurrent','asyncio','inspect'}
