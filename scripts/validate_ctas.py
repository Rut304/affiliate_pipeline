#!/usr/bin/env python3
import os
from _utils import load_yaml, dump_yaml, list_packs, ensure_dir, write_csv, log, env_run_id
...
def main():
    ...
    for pack in packs:
        ...
        if not input_found:
            ...
            try:
                ...
                before = (data.get("cta_primary") or "") if isinstance(data, dict) else ""
    ...
    write_csv(out_csv, rows, ["run_id","pack","input_yaml_found","cta_before","cta_after","changed","note"])
